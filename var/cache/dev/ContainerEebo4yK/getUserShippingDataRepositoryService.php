...
// Returns the private 'App\Repository\UserShippingDataRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserShippingDataRepository.php';

return $this->privates['App\Repository\UserShippingDataRepository'] = new \App\Repository\UserShippingDataRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
