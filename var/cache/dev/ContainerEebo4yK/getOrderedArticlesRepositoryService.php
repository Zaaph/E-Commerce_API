...
// Returns the private 'App\Repository\OrderedArticlesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/OrderedArticlesRepository.php';

return $this->privates['App\Repository\OrderedArticlesRepository'] = new \App\Repository\OrderedArticlesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
